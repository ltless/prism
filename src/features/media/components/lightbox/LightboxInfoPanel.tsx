...
// Fast ease-out tween, not a spring: opening should feel instant, the slide is
// just the tail. A spring (stiffness 300/damping 30) held the panel mostly
// offscreen for the first ~150ms and crept in after.
