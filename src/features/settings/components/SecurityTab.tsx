...
import { LockKey, Shield, Spinner, Check, ShieldWarning } from "@phosphor-icons/react";
...
import type { PinDialogType } from "./PinVaultDialog";

type PinDialog = PinDialogType | null;
