...
export function AdminAITab({ ai, tagStats, onSetTagStats, scoreStats, onSetScoreStats }: AITabProps) {
  const { downloadCLIP, activateModel, downloadAesthetic, cancelClip, aestheticDownloaded, setAestheticDownloaded } = useModelDownload(ai);
 ...
 <span>More Tags (0.05)</span><span>More Precise (0.95)</span>
  ...
  // 2. Score all unscored (if aesthetic enabled)
